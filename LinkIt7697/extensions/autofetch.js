	...
	var zhhant_path = "https://lioujj.github.io/LinkIt7697/extensions/zh-hant.js";  //載入自訂積木繁體語系設定檔(預設繁體語系)
	var blocks_path = "https://lioujj.github.io/LinkIt7697/extensions/blocks.js";   //載入自訂積木定義檔
	var javascript_path = "https://lioujj.github.io/LinkIt7697/extensions/javascript.js";   //載入自訂積木轉出程式碼檔
	var toolbox_path = "https://lioujj.github.io/LinkIt7697/extensions/toolbox.xml";  //讀取自訂積木目錄檔
	...
	var myTimer = setInterval(function(){
		if (document.getElementById('select-lang-en').checked!=document.getElementById('select-lang-zh').checked) {
			...
			if ((document.getElementById('select-lang-en').checked)) {
				var en_path = "https://lioujj.github.io/LinkIt7697/extensions/en.js";  //載入自訂積木英文語系設定檔
