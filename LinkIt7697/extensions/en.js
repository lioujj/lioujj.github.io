...
Blockly.Msg.LJJ_SERIAL_END = 'end';
...
Blockly.Msg.IR_SENDER_PIN_TITLE = "Set IR transmitter pin:";
...
Blockly.Msg.LDM6432_PUT_NUMBER_CONTENT = "LDM put single number:";
...
Blockly.Msg.LDM6432_FONTSIZE = "size:";
Blockly.Msg.LDM6432_TRANSPARENT = "set font or pattern overlay on background:";
Blockly.Msg.LDM6432_COLOR_CODE= "color code";
Blockly.Msg.LDM6432_COLOR=[['black','0'],['white','111'],['red','96'],['orange','100'],['yellow','108'],['green','4'],['blue','3'],['cyan','15'],['indigo','66'],['purple','99'],['dark red','32'],['pink','103'],['earth yellow','104'],['lime','12']];
...
Blockly.Msg.OLED_DISPLAY_SPI_TYPE_LIST = [["HW SPI","HW"],["SW SPI","SW"]];
...
Blockly.Msg.BROADCAST_UDP_RECEIVED_EVENT = "on received message";
Blockly.Msg.BROADCAST_UDP_RECEIVED_MSG = "received message";
Blockly.Msg.BROADCAST_UDP_V7RC = "if received message includes V7RC control code"
...
Blockly.Msg.BROADCAST_UDP_SEND_IP = "to IP:";
...
Blockly.Msg.KSB065_ANALOG_LIST=[["slider value","33"],["light sensor value","4"]];
...
Blockly.Msg.LINENOTIFY_SEND_MSG = "send message";
...
Blockly.Msg.POCKETCARD_DAC_INIT = "audio board initial";
...
Blockly.Msg.DAC_FILE_SOURCE_TITLE = "play voice file from";
Blockly.Msg.DAC_FILE_SOURCE = [["SD card","1"],["SPIFFS","2"]];
Blockly.Msg.DAC_FILE_NAME = "file name(include path)";
Blockly.Msg.DAC_MP3_END = "when voice file ends";
Blockly.Msg.DAC_MP3_ENDS_WITH = "if voice file name is";
...
Blockly.Msg.CCS811_UPDATE = "calculate the result";
Blockly.Msg.CCS811_CHECK = "is dataAvailable?";
Blockly.Msg.CCS811_WARNING= "You have to set \""+Blockly.Msg.CCS811_TITLE+" "+Blockly.Msg.CCS811_INIT+"\" first.";
Blockly.Msg.CCS811_GET_DATA = "get the data of";
Blockly.Msg.CCS811_FREQ= "set measurement frequence:every";
Blockly.Msg.CCS811_FREQ_UNIT = "seconds";
...
Blockly.Msg.I2S_MIC_START = "start";
Blockly.Msg.I2S_MIC_STOP = "stop";
...
Blockly.Msg.I2S_MIC_DIRECT_UPLOAD = "direct upload voice to Azure to recognize";
...
Blockly.Msg.LMX_7SEG_TITLE = "Lumex 7-seg display";
Blockly.Msg.LMX_7SEG_INIT = "connect to ESP32";
Blockly.Msg.LMX_7SEG_TOOLTIP = "";
Blockly.Msg.LMX_7697_INIT = "connect to 7697";
Blockly.Msg.LMX_7SEG_DIGITS_COUNT = "set the length of display characters";
Blockly.Msg.LMX_7SEG_CLEAR = "display clear";
Blockly.Msg.LMX_7SEG_ALIGN_TYPE=[["right","right"],["left","left"]];
Blockly.Msg.LMX_7SEG_PUT_NUMBER = "show number";
Blockly.Msg.LMX_7SEG_ALIGN = "align:";
Blockly.Msg.LMX_7SEG_BLINK = "start to blink";
Blockly.Msg.LMX_7SEG_FREQ = "frequency(0~10)";
Blockly.Msg.LMX_7SEG_STOP_BLINK = "stop blinking";
Blockly.Msg.LMX_7SEG_LIGHT_LEVEL= "adjust display brightness(0~4)";
Blockly.Msg.LMX_7SEG_PUT_STRING = "show string";
Blockly.Msg.LMX_7SEG_PUT_SINGLE = "show single number";
Blockly.Msg.LMX_7SEG_POS = "on x:";
Blockly.Msg.LMX_7SEG_CLEAR_INDICATOR = "clear indicator light";
Blockly.Msg.LMX_7SEG_INDICATOR_LIST =[["left side","4"],["right side","5"],["both side","6"]];
Blockly.Msg.LMX_7SEG_SET = "set indicator";
Blockly.Msg.LMX_7SEG_SHOW_LEVEL ="level(0~6):";
Blockly.Msg.LMX_7SEG_MODE_INDICATOR ="set indicators display mode";
Blockly.Msg.LMX_7SEG_INDICATOR_MODE_LIST = [["mode 1","0"],["mode 2","1"],["mode 3","2"]];
Blockly.Msg.LMX_7SEG_TX_PIN = "RX connect to";
...
Blockly.Msg.LJJ_CAMERA_TITLE ="CAMERA"
Blockly.Msg.LJJ_CAMERA_INIT = "initial";
Blockly.Msg.LJJ_CAMERA_TYPE = "board type";
...
Blockly.Msg.LJJ_BASIC_LINE_FOLLOWER_1_WAYS_LIST = [["middle","ljjBasicLineMiddlePin"]];
...
Blockly.Msg.LJJ_BASIC_LINE_FOLLOWER_TOOLTIP = "https://sites.google.com/jes.mlc.edu.tw/ljj/linkit7697/lineFollower";
...
Blockly.Msg.LJJ_LCD1602_BITMAP = 'set custom font bitmap';
Blockly.Msg.LJJ_LCD1602_BITMAP_SHOW= 'show custom font bitmap';
Blockly.Msg.LJJ_LCD1602_CHAR = 'show ASCII character';
Blockly.Msg.LJJ_LCD1602_CHAR_INDEX = 'index';
Blockly.Msg.LJJ_LCD1602_CHAR_BINARY = 'binary?'
Blockly.Msg.LJJ_LCD1602_BITMAP_INDEX = 'index(0~7)';
...
Blockly.Msg.LJJ_BROADCAST_CHANNEL = "channel number(1~13)";
...
Blockly.Msg.LJJ_SU03T_RECONNECT = 'reconnect to';
...
Blockly.Msg.LJJ_SERVO_ATTACH = 'attach';
...
Blockly.Msg.LJJ_ESP32_BLE_V7RC_DATATYPE=[["vehicle","SRV"],["tank","SRT"],["LED1~4","LED"],["LED5~8","LE2"]];
...
Blockly.Msg.LJJ_SEN0539_TITLE = "SEN0539_I2C ASR";
Blockly.Msg.LJJ_SEN0539_RECOGNIZED = 'recognizeed';
Blockly.Msg.LJJ_SEN0539_WAKEUP_SECONDS = "set wake time(second)";
Blockly.Msg.LJJ_SEN0539_VOLUME = "set volume";
Blockly.Msg.LJJ_SEN0539_MUTE = "set mute";
Blockly.Msg.LJJ_SEN0539_EXECUTE = "excute";
Blockly.Msg.LJJ_SEN0539_COMMAND_TYPE=[
  ["fixed command","fixed"],["wake-up command","wake"],["custom command","custom"],["learning command","learning"]
];
...
Blockly.Msg.LJJ_SEN0539_WAKE_COMMAND_LIST = [["學習的喚醒詞","1"],["小智你好","2"],["小愛同學","3"]];
...
Blockly.Msg.LJJ_PMS_DATATYPE = [["Standard Particles PM1.0","PM_SP_UG_1_0"],["Standard Particles PM2.5","PM_SP_UG_2_5"],["Standard Particles PM10","PM_SP_UG_10_0"],["Atmospheric environment PM1.0","PM_AE_UG_1_0"],["Atmospheric environment PM2.5","PM_AE_UG_2_5"],["Atmospheric environment PM10","PM_AE_UG_10_0"]];
...
Blockly.Msg.LJJ_PMS_ACTION =[["passive mode","passiveMode"],["active mode","activeMode"],["sleep","sleep"],["wake up","wakeUp"]];
