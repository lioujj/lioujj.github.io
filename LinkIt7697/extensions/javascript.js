...
Blockly.Arduino.fetchFromSheet=function(){
  ...
  if (Blockly.Arduino.my_board_type=="ESP32" || Blockly.Arduino.my_board_type=="ESP8266" || Blockly.Arduino.my_board_type=="Pico"){
    if (Blockly.Arduino.my_board_type=="ESP32")
      Blockly.Arduino.definitions_.define_sheet_json_doc_invoke='DynamicJsonDocument docSheet(6144);\n';
    Blockly.Arduino.definitions_.define_secure_include="#include <WiFiClientSecure.h>";
...
Blockly.Arduino.ljj_radar_03D_available = function() { 
  var a=Blockly.Arduino.statementToCode(this,"Rd_03D");
  a='  '+a.replace(/\n/g,'\n  ');
  Blockly.Arduino.definitions_.define_ljj_radar_rd03d_invoke='typedef struct\n{\n  int x;\n  int y;\n  int s;\n  int d;\n}  targetDataType;\ntargetDataType targetData[3];\n';
